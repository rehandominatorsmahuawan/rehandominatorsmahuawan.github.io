...
function textNode(n){const p=n.parentElement;if(!p||SKIP.has(p.tagName)||p.closest('[data-rdm-no-mini]'))return;const v=n.nodeValue||'';if(/[A-Za-z]/.test(v))n.nodeValue=mini(v)}
function control(el){
